...
namespace Kit.Containers
{
	...
	///     <see cref="Upgrade" /> or the base value of the property changes. When used in a <see cref="UnityEngine.MonoBehaviour" />, it also
	///     provides custom inspectors for viewing and changing values.
	/// </remarks>
	/// <example>
	///     <code>
